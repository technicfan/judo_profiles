    ...
    switch (type) {
        case "special":
            ...
            <div class="special rank_item" id="special_item` +
                ...
                <button id="special_b` +
                number +
                `" class="btn btn-danger btn-sm" onclick="remove_rank('special', this)">Entfernen</button>
            </div>
            `;
            break;
        case "ground":
            ...
            <div class="ground rank_item" id="ground_item` +
                ...
                <button id="ground_b` +
                number +
                `" class="btn btn-danger btn-sm" onclick="remove_rank('ground', this)">Entfernen</button>
            </div>
            `;
            break;
        case "combination":
            ...
            <div class="combination rank_item" id="combination_item` +
                ...
                number +
                `" class="btn btn-danger btn-sm" onclick="remove_rank('combination', this)">Entfernen</button>
            </div>
            `;
            break;
    }
